...
public class BusquedaDatoInvalido {
    ...
    public void preparAmbiente() {
        ...
        ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("C:\\Selenium\\reportes\\buscainvalidaespeciales.html");
        extent.attachReporter(htmlReporter);
        logger = extent.createTest("BusquedaDatoInvalido");
    }
    ...
    public void Busqueda_Invalida() {
        ...
        logger.log(Status.PASS, "La prueba de búsqueda invalida con caracteres especiales se completó correctamente.");
    }
